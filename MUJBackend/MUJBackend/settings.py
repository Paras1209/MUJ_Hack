"""
Django settings for MUJBackend project.
...
SECRET_KEY = 'django-insecure-!22lgv%ivon%x_5=m0!q57(z-9g(7)n@#&fx65tfwj=&zp8y5o'
...
WSGI_APPLICATION = 'MUJBackend.wsgi.application'
